    ...
    if (searchResult.success && searchResult.data) {
        ...
        const registroPayload = {
          ...
          saldo_usado: saldoUsado, // Incluir o tipo de saldo usado
            metadata: {
              ...
              module_id: 155, // ID do módulo CPF COMPLETO
      ...
      if (preCheck.success && preCheck.exists && preCheck.data) {
        ...
        const registroPayload = {
          ...
          saldo_usado: saldoUsado,
          metadata: {
            source: 'consultar-cpf-completo-precheck',
            page_route: window.location.pathname,
            discount: metadata.discount || 0,
...
const ConsultarCpfCompleto = () => {
  ...
  // Carregar preço do módulo ID 155 da API
  const loadModulePrice = async () => {
    try {
      setModulePriceLoading(true);
      console.log('💰 Carregando preço do módulo ID 155 via API...');
      
      // Buscar preço direto da API usando o serviço correto
      const price = await getModulePriceById(155);
      
      if (price && price > 0) {
        setModulePrice(price);
        console.log('✅ Preço do módulo ID 155 carregado da API:', price);
      } else {
      ...
      console.error('❌ Erro ao carregar preço do módulo ID 155:', error);
  ...
  return (
    <div className="space-y-4 md:space-y-6 max-w-full overflow-x-hidden">
      <div className="w-full">
        <SimpleTitleBar
          title="Consulta CPF Completo"
          subtitle="Consulte dados completos do CPF na base de dados"
